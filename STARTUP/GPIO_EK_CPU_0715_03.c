...
//			<o1.16..17>	Pin PA8	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<o1.26..27>	Pin PA13	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.28..29>	Pin PA14	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.30..31>	Pin PA15	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//		</e>
...
//			<q2.8>	Pin PA8 - Output open-drain
...
//			<q2.13>	Pin PA13 - Output open-drain
//			<q2.14>	Pin PA14 - Output open-drain
//			<q2.15>	Pin PA15 - Output open-drain
//		</e>
...
//			<o3.16..17>	Pin PA8	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o3.26..27>	Pin PA13	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.28..29>	Pin PA14	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.30..31>	Pin PA15	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//		</e>
...
//			<o4.16..17>	Pin PA8	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
//			<o4.26..27>	Pin PA13	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.28..29>	Pin PA14	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.30..31>	Pin PA15	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//		</e>
...
//			<q5.29>	Pin PA13 - Reset
//			<q5.30>	Pin PA14 - Reset
//			<q5.31>	Pin PA15 - Reset
//		</e>
...
#define GPIOAMODER			0x000000FF
#define GPIOAOTYPER			0x0000
#define GPIOAOSPEEDR		0x00000000
#define GPIOAPUPDR			0xAAAAAA00
#define GPIOABSRR				0xFFFF0000
#define GPIOAAFRL				0x03000111
#define GPIOAAFRH				0x21101111
//	</e>		
...
//			<o1.4..5>	PB2 	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<o3.4..5>	PB2 	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.4..5>	PB2 	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
#define GPIOBMODER			0x00000000
#define GPIOBOTYPER			0x0000
#define GPIOBOSPEEDR		0x55555540
#define GPIOBPUPDR			0xAAAAAAAA
#define GPIOBBSRR				0xFFFF0000
#define GPIOBAFRL				0x77666020
#define GPIOBAFRH				0x11117799
//	</e>		
...
//			<o1.8..9>	PC4 (ADC2 BUSY)	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.10..11>	PC5 (ADC1 BUSY)	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<q2.4>	PC4 (ADC2 BUSY) - Output open-drain
//			<q2.5>	PC5 (ADC1 BUSY) - Output open-drain
...
//			<o3.8..9>	PC4 (ADC2 BUSY)	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.10..11>	PC5 (ADC1 BUSY)	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.8..9>	PC4 (ADC2 BUSY)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.10..11>	PC5 (ADC1 BUSY)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
//			<q5.2>	PC2 - Set
//			<q5.3>	PC3 - Set
//			<q5.4>	PC4 (ADC2 BUSY) - Set
//			<q5.5>	PC5 (ADC1 BUSY) - Set
//			<q5.6>	PC6 - Set
//			<q5.7>	PC7 - Set
//			<q5.8>	PC8 - Set
//			<q5.9>	PC9 - Set
...
//			<q5.18>	PC2 - Reset
//			<q5.19>	PC3 - Reset
//			<q5.20>	PC4 (ADC2 BUSY) - Reset
//			<q5.21>	PC5 (ADC1 BUSY) - Reset
//			<q5.22>	PC6 - Reset
//			<q5.23>	PC7 - Reset
//			<q5.24>	PC8 - Reset
//			<q5.25>	PC9 - Reset
...
//			<o6.12..15>	PC3		
//				<0=> AF0
//			<o6.16..19>	PC4 (ADC2 BUSY)	
//				<0=> AF0
//			<o6.20..23>	PC5 (ADC1 BUSY)	
//				<0=> AF0
//			<o6.24..27>	PC6	
//				<0=> AF0
...
#define GPIOCMODER			0x00A0A0FF
#define GPIOCOTYPER			0x0000
#define GPIOCOSPEEDR		0x0050A000
#define GPIOCPUPDR			0xAA0A0A00
#define GPIOCBSRR				0xFFFF0000
#define GPIOCAFRL				0x88000000
#define GPIOCAFRH				0x00008800
//	</e>		
...
//			<o1.12..13>	PD6 	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.14..15>	PD7	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<q2.6>	PD6  - Output open-drain
//			<q2.7>	PD7 - Output open-drain
...
//			<o3.12..13>	PD6 	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.14..15>	PD7	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.12..13>	PD6 	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.14..15>	PD7	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
#define GPIODMODER			0x00000000
#define GPIODOTYPER			0x0000
#define GPIODOSPEEDR		0x00000000
#define GPIODPUPDR			0x00AAAAAA
#define GPIODBSRR				0xFFFFF000
#define GPIODAFRL				0x00000000
#define GPIODAFRH				0x22220000
//	</e>		
...
//			<o1.6..7>	PE3 (UART8 (X9) DE)	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<q2.3>	PE3 (UART8 (X9) DE) - Output open-drain
...
//			<o3.6..7>	PE3 (UART8 (X9) DE)	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.6..7>	PE3 (UART8 (X9) DE)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
#define GPIOEMODER			0x00002920
#define GPIOEOTYPER			0x0000
#define GPIOEOSPEEDR		0x00002820
#define GPIOEPUPDR			0xA00A808A
#define GPIOEBSRR				0xFFEF3C10
#define GPIOEAFRL				0xC5511588
...
//				<12=> FMC_A9 (default)
//		</e>
#define GPIOFCLOCK			0x0001
#define GPIOFMODER			0x00000000
#define GPIOFOTYPER			0x0000
#define GPIOFOSPEEDR		0x00000000
#define GPIOFPUPDR			0xAAAAAAAA
#define GPIOFBSRR				0xFFFF0000
...
//			<o1.12..13>	PG6 (ACT OE2)	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.14..15>	PG7 (ACT OE1)	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
//			<o1.16..17>	PG8 LED	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<o1.22..23>	PG11	<0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<q2.6>	PG6 (ACT OE2) - Output open-drain
//			<q2.7>	PG7 (ACT OE1) - Output open-drain
//			<q2.8>	PG8 LED - Output open-drain
//			<q2.9>	PG9 - Output open-drain
//			<q2.10>	PG10 - Output open-drain
//			<q2.11>	PG11 - Output open-drain
...
//			<o3.12..13>	PG6 (ACT OE2)	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.14..15>	PG7 (ACT OE1)	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
//			<o3.16..17>	PG8 LED	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o3.22..23>	PG11	<0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.12..13>	PG6 (ACT OE2)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.14..15>	PG7 (ACT OE1)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
//			<o4.16..17>	PG8 LED	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
//			<o4.22..23>	PG11	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
//			<q5.4>	PG4 - Set
//			<q5.5>	PG5 - Set
//			<q5.6>	PG6 (ACT OE2) - Set
//			<q5.7>	PG7 (ACT OE1) - Set
//			<q5.8>	PG8 LED - Set
//			<q5.9>	PG9 - Set
//			<q5.10>	PG10 - Set
//			<q5.11>	PG11 - Set
...
//			<q5.20>	PG4 - Reset
//			<q5.21>	PG5 - Reset
//			<q5.22>	PG6 (ACT OE2) - Reset
//			<q5.23>	PG7 (ACT OE1) - Reset
//			<q5.24>	PG8 LED - Reset
//			<q5.25>	PG9 - Reset
//			<q5.26>	PG10 - Reset
//			<q5.27>	PG11 - Reset
...
//			<o6.20..23>	PG5	
//				<12=> FMC_A15 (default)
//			<o6.24..27>	PG6 (ACT OE2)	
//				<0=> AF0 (default)
//			<o6.28..31>	PG7 (ACT OE1)	
//				<0=> AF0 (default)
//			<o7.0..3>		PG8 LED	
//				<0=> AF0 (default)
//			<o7.4..7>	PG9
...
#define GPIOGMODER			0x00000005
#define GPIOGOTYPER			0x0000
#define GPIOGOSPEEDR		0x00000000
#define GPIOGPUPDR			0xAAAA0000
#define GPIOGBSRR				0xFFFF0003
...
#define GPIOHMODER			0x00000000
#define GPIOHOTYPER			0x0000
#define GPIOHOSPEEDR		0x00000000
#define GPIOHPUPDR			0xAAAAAAA0
...
#define GPIOIPUPDR			0x00AAAAAAul
#define GPIOIBSRR				0xFFFF0000ul
