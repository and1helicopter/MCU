...
#define GPIOAMODER			0x00AAEFE1
#define GPIOAOTYPER			0x0000
#define GPIOAOSPEEDR		0x00000000
#define GPIOAPUPDR			0x10001000
#define GPIOABSRR				0xFFFF0800
#define GPIOAAFRL				0x03000711
...
//			<o1.2..3>	PB1 (ADC CONVST) <0=> Input	<1=> General purpose output mode <2=> Alternate function mode <3=> Analog mode
...
//			<q2.1>	PB1 (ADC CONVST)- Output open-drain
...
//			<o3.2..3>	PB1 (ADC CONVST) <0=> Low speed (4MHz)	<1=> Medium speed (25 MHz) <2=> Fast speed (50 MHz) <3=> High speed (100 MHz)
...
//			<o4.2..3>	PB1 (ADC CONVST)	<0=> No pull-up, pull-down	<1=> Pull-up <2=> Pull-down <3=> Reserved
...
#define GPIOBMODER			0xAAAAAA98
#define GPIOBOTYPER			0x0000
#define GPIOBOSPEEDR		0x55555540
#define GPIOBPUPDR			0x01000004
...
#define GPIODMODER			0xAAAAAA2A
#define GPIODOTYPER			0x0000
#define GPIODOSPEEDR		0xFFFFCF1F
#define GPIODPUPDR			0x00000000
#define GPIODBSRR				0xFFFF0000
#define GPIODAFRL				0xC7CC08CC
...
#define GPIOEMODER			0xAAAAA96A
#define GPIOEOTYPER			0x0000
#define GPIOEOSPEEDR		0xFFFFE825
...
#define GPIOFMODER			0xAA001AAA
#define GPIOFOTYPER			0x0000
#define GPIOFOSPEEDR		0xFF000FFF
#define GPIOFPUPDR			0x0000A000
