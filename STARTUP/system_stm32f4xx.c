/**
  ...
  *                      and Dividerextmeme factors, AHB/APBx prescalers and Flash settings),
  ...
  *        System Clock source                    | PLL (HSE)
  *-----------------------------------------------------------------------------
  *        SYSCLK(Hz)                             | 180000000 / 168000000 (USB)
  *-----------------------------------------------------------------------------
  *        HCLK(Hz)                               | 180000000 / 168000000 (USB)
  *-----------------------------------------------------------------------------
  *        AHB Prescaler                          | 1
  *-----------------------------------------------------------------------------
  *        APB1 Prescaler                         | 4
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    PWR->CR 		 |= PWR_CR_VOS;
		...
		/* Select MCO2 Output	*/
//		RCC->CFGR |= RCC_CFGR_MCO2_1;					/*Petrov.*/
