...
__align(4) unsigned char USART1_TX_Buff[128];
__align(4) unsigned char USART1_RX_Buff[128];
					
__align(4) unsigned char USART2_TX_Buff[128];
__align(4) unsigned char USART2_RX_Buff[128];
					
__align(4) unsigned char USART3_TX_Buff[128];
__align(4) unsigned char USART3_RX_Buff[128];
					
__align(4) unsigned char USART4_TX_Buff[128];
__align(4) unsigned char USART4_RX_Buff[128];
					
__align(4) unsigned char USART5_TX_Buff[128];
__align(4) unsigned char USART5_RX_Buff[128];
					
__align(4) unsigned char USART6_TX_Buff[128];
__align(4) unsigned char USART6_RX_Buff[128];

__align(4) unsigned char USART7_TX_Buff[128];
__align(4) unsigned char USART7_RX_Buff[128];

__align(4) unsigned char USART8_TX_Buff[128];
__align(4) unsigned char USART8_RX_Buff[128];

static short ParitySelect[4] = { ((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200), ((uint16_t)0x1000)|((uint16_t)0x0400), 0x0000, 0x0000 };
...
void InitUsart(int Channel, int Params, UsartProc_Type Proc) {
	...
	switch (Channel) {
	  case 1:		{	 
								...
								if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR & ((uint32_t)0x00000010)) return;						 
								((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR |= ((uint32_t)0x00000010);												 
			
								USART1_Proc 	= Proc;
	
								((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= ((uint32_t)0x00400000);													 

								 
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 6);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->PAR 	= (unsigned int)&(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR);
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->M0AR 	= (unsigned int)USART1_RX_Buff;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->NDTR 	= 128;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->CR	 	= (4ul << 25) 	|												 
																			(0ul<< 6)			|												 
																			((uint32_t)0x00000400)	|												 
																			((uint32_t)0x00000001);													 

								 	
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 22);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->PAR 	= (unsigned int)&(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR);
							
							
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR	 	= (4ul << 25) 		|											 
																			(1ul<< 6)				|											 
																			((uint32_t)0x00000400);												 

								((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->BRR	  			=	(SystemCoreClock / 2) / SpeedSelect[(Params & 0x700) >> 8];	 
								((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR3					= ((uint16_t)0x0080)	|											 
																			((uint16_t)0x0040);												 
	
								((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR2					= (Params & 0x01) << 13;								 
	
								((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1					=	((uint16_t)0x0004)			|										 
																			((uint16_t)0x0008)			|										 
																			((uint16_t)0x0010)	|										 
																			((uint16_t)0x0040)		|										 
																			ParitySelect[(Params & 0x06) >> 1] |	 
																			((uint16_t)0x2000);													 
	  ...
	  case 2:		{	 
								...
								if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00020000)) return;						 
								((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= ((uint32_t)0x00020000);												 
			
								USART2_Proc 	= Proc;
	
								((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= ((uint32_t)0x00200000);													 

								 
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 6);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR);
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->M0AR 	= (unsigned int)USART2_RX_Buff;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->NDTR 	= 128;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->CR	 	= (4ul << 25) 	|												 
																			(0ul<< 6)			|												 
																			((uint32_t)0x00000400)	|												 
																			((uint32_t)0x00000001);													 

								 	
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 16);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR);
							
							
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR	 	= (4ul << 25) 		|											 
																			(1ul<< 6)				|											 
																			((uint32_t)0x00000400);												 

								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->BRR	  			=	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];	 
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR3					= ((uint16_t)0x0080)	|											 
																			((uint16_t)0x0040);												 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR2					= (Params & 0x01) << 13;								 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1					=	((uint16_t)0x0004)			|										 
																			((uint16_t)0x0008)			|										 
																			((uint16_t)0x0010)	|										 
																			((uint16_t)0x0040)		|										 
																			ParitySelect[(Params & 0x06) >> 1] |	 
	  ...
	  case 3:		{	 
								...
								if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00040000)) return;						 
								...
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 6);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR);
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->M0AR 	= (unsigned int)USART3_RX_Buff;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->NDTR 	= 128;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->CR	 	= (4ul << 25) 	|												 
																			(0ul<< 6)			|												 
																			((uint32_t)0x00000400)	|												 
																			((uint32_t)0x00000001);													 

								 	
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 22);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR);
							
							
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR	 	= (4ul << 25) 		|											 
																			(1ul<< 6)				|											 
																			((uint32_t)0x00000400);												 

								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->BRR	  			=	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];	 
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR3					= ((uint16_t)0x0080)	|											 
																			((uint16_t)0x0040);												 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR2					= (Params & 0x01) << 13;								 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1					=	((uint16_t)0x0004)			|										 
																			((uint16_t)0x0008)			|										 
																			((uint16_t)0x0010)	|										 
																			((uint16_t)0x0040)		|										 
																			ParitySelect[(Params & 0x06) >> 1] |	 
		...
		case 4:		{	 
								...
								if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00080000)) return;							 
								...
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 16);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->DR);
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->M0AR 	= (unsigned int)USART4_RX_Buff;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->NDTR 	= 128;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->CR	 	= (4ul << 25) 	|												 
																			(0ul<< 6)			|												 
																			((uint32_t)0x00000400)	|												 
																			((uint32_t)0x00000001);													 

								 	
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 0);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->DR);
							
							
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR	 	= (4ul << 25) 		|											 
																			(1ul<< 6)				|											 
																			((uint32_t)0x00000400);												 

								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->BRR	  			=	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];	 
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR3					= ((uint16_t)0x0080)	|											 
																			((uint16_t)0x0040);												 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR2					= (Params & 0x01) << 13;								 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1					=	((uint16_t)0x0004)			|										 
																			((uint16_t)0x0008)			|										 
																			((uint16_t)0x0010)	|										 
																			((uint16_t)0x0040)		|										 
																			ParitySelect[(Params & 0x06) >> 1] |	 
		...
		case 5:		{	 
								...
								if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00100000)) return;							 
								((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= ((uint32_t)0x00100000);												 
								...
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 0);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->DR);
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->M0AR 	= (unsigned int)USART5_RX_Buff;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->NDTR 	= 128;
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->CR	 	= (4ul << 25) 	|												 
																			(0ul<< 6)			|												 
																			((uint32_t)0x00000400)	|												 
																			((uint32_t)0x00000001);													 

								 	
								((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 22);												 
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->PAR 	= (unsigned int)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->DR);
							
							
								((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR	 	= (4ul << 25) 		|											 
																			(1ul<< 6)				|											 
																			((uint32_t)0x00000400);												 

								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->BRR	  			=	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];	 
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR3					= ((uint16_t)0x0080)	|											 
																			((uint16_t)0x0040);												 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR2					= (Params & 0x01) << 13;								 
	
								((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1					=	((uint16_t)0x0004)			|										 
																			((uint16_t)0x0008)			|										 
																			((uint16_t)0x0010)	|										 
																			((uint16_t)0x0040)		|										 
																			ParitySelect[(Params & 0x06) >> 1] |	 
...
int TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->SR;
	Temp   = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 6);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->M0AR 	= (unsigned int)USART1_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 22);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->M0AR 	= (unsigned int)USART1_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->NDTR 	= TX_RX_Count;													 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->SR;
	Temp   = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 6);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->M0AR 	= (unsigned int)USART2_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 16);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->M0AR 	= (unsigned int)USART2_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->NDTR 	= TX_RX_Count;													 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int USART3_TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR;
	Temp   = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	USART3_TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 6);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->M0AR 	= (unsigned int)USART3_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (USART3_TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 22);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->M0AR 	= (unsigned int)USART3_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->NDTR 	= USART3_TX_RX_Count;										 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->SR;
	Temp   = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 16);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->M0AR 	= (unsigned int)USART4_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 0);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->M0AR 	= (unsigned int)USART4_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->NDTR 	= TX_RX_Count;													 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->SR;
	Temp   = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 0);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->M0AR 	= (unsigned int)USART5_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 22);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->M0AR 	= (unsigned int)USART5_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->NDTR 	= TX_RX_Count;													 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int TX_RX_Count = 0;	
	...
	Status = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->SR;
	Temp   = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->DR;

	if (Status & ((uint16_t)0x0040))	{																		 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->SR) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0;									 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
		return;
	}
	
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0; 									 
	(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 0; 								 
	
	TX_RX_Count = (128 - ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->NDTR);
	
	 
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;							 
  while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));					 
	
	((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->LIFCR				 	= (0x3Dul << 16);													 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->M0AR 	= (unsigned int)USART6_RX_Buff;						 
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->NDTR 	= 128;											 
													
	(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;							 
	...
	if (TX_RX_Count > 0) {
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
		while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
		((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 16);												 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0))->M0AR 	= (unsigned int)USART6_TX_Buff;					 
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0))->NDTR 	= TX_RX_Count;													 
													
		(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 1;						 	
		}	else 
		{
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR3) - ((uint32_t)0x40000000))*32 + 6*4) + ((uint32_t)0x42000000))) = 1; 							 
		(*(volatile unsigned int *)((((unsigned int)(&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->CR1) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1; 								 
...
int  MasterSend(int Port, int TX_Count, int SendMode, unsigned char *TX_Buff) {
	...
	switch (Port)	{
		...
		case 1:	{	if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR & ((uint32_t)0x00000010)) == 0) return 0;		 
			
							(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
							while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
							((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->HIFCR				 	= (0x3Dul << 22);												 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->M0AR 	= (unsigned int)TX_Buff;								 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))->NDTR 	= TX_Count;															 
		...
		case 2:	{ if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00020000)) == 0) return 0;		 
			
							(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
							while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
							((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 16);												 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->M0AR 	= (unsigned int)TX_Buff;								 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0))->NDTR 	= TX_Count;															 
		...
		case 3:	{ if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00040000)) == 0) return 0;		 
			
							(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
							while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
							((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->LIFCR				 	= (0x3Dul << 22);												 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->M0AR 	= (unsigned int)TX_Buff;								 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->NDTR 	= TX_Count;															 
		...
		case 4:	{ if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00080000)) == 0) return 0;		 

							(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
							while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
							((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 0);												 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->M0AR 	= (unsigned int)TX_Buff;								 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070))->NDTR 	= TX_Count;															 
		...
		case 5:	{ if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR & ((uint32_t)0x00100000)) == 0) return 0;		 

							(*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))) = 0;						 
							while ((*(volatile unsigned int *)((((unsigned int)(&((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->CR) - ((uint32_t)0x40000000))*32 + 0*4) + ((uint32_t)0x42000000))));				 
	
							((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6000))->HIFCR				 	= (0x3Dul << 22);												 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->M0AR 	= (unsigned int)TX_Buff;								 
							((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))->NDTR 	= TX_Count;															 
...
unsigned int Addr;	
	...
	if (Count!=8) return ModbusErr(0x03, RxBuff, TxBuff);
		 ...
		 i 	= (RxBuff[4] << 8) | RxBuff[5];	if ((i == 0) || (i > ((128 - 5) >> 1) )) return ModbusErr(0x02, RxBuff, TxBuff);
...
unsigned int Addr;	
	...
	if ((Addr == 0x0259) && (i == 3)) {
		Metro . StdCmnd . StdCmnd .SetTime = RxBuff[8]  | (RxBuff[10] << 8) | (RxBuff[12] << 16);
	...
	if ((Addr == 0x025D) && (i == 3)) {
		Metro . StdCmnd . StdCmnd .SetDate = RxBuff[8]  | (RxBuff[10] << 8) | (RxBuff[12] << 16);
...
void SetUartParams(int Channel, int Params) {
	switch (Channel) {
		...
		case 1:	{ ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->BRR	 =	(SystemCoreClock / 2) / SpeedSelect[(Params & 0x700) >> 8];		 
							((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR2	 = (Params & 0x01) << 13;														 
																																							 
							((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1  = (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;		


		case 2:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->BRR	 =	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];		 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR2	 = (Params & 0x01) << 13;														 
																																							 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;
		...
		case 3:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->BRR	 =	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];		 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR2	 = (Params & 0x01) << 13;														 
																																							 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;



  	case 4:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->BRR	 =	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];		 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR2	 = (Params & 0x01) << 13;														 
																																							 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;



		case 5:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->BRR	 =	(SystemCoreClock / 4) / SpeedSelect[(Params & 0x700) >> 8];		 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR2	 = (Params & 0x01) << 13;														 
																																							 
							((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;


#line 974 "PERIPH\\usart.c"
	}
} 
...
void SetUartParity(int Channel, int Params) {
	switch (Channel) {
		...
		case 1:	{ ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1 = (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;	


		case 2:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1 = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;


		case 3:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1 = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;


		case 4:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;


		case 5:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1  = (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR1 & ~(((uint16_t)0x1000)|((uint16_t)0x0400)|((uint16_t)0x0200))) | ParitySelect[(Params & 0x06) >> 1];
						} break;
...
void SetUartStopBits(int Channel, int Params) {
	switch (Channel) {
		...
		case 1:	{ ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR2	 = (Params & 0x01) << 13;														 
						} break;


		case 2:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->CR2	 = (Params & 0x01) << 13;														 
						} break;


		case 3:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR2	 = (Params & 0x01) << 13;														 
						} break;


		case 4:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))->CR2	 = (Params & 0x01) << 13;														 
						} break;


		case 5:	{ ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000))->CR2	 = (Params & 0x01) << 13;														 
						} break;
 ...
 int GetSavedUartParams(int Port) 						{return Metro . SavedParam . SavedParam .UartParams[(Port-1) &0x07];	}
void PutSavedUartParams(int Port, int Params) {Metro . SavedParam . SavedParam .UartParams[(Port-1) &0x07] = Params;}
