...
#line 3 "PERIPH\\mcan.c"



void InitCAN1(void) {
	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= ((uint32_t)0x02000000);

	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->MCR 	  = ((uint16_t)0x0001);								 	
	while ((((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->MSR & ((uint16_t)0x0001)) == 0) {}	 
		
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->MCR		 |= ((uint16_t)0x0040) |							 
									((uint16_t)0x0004);								 
	...
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->BTR		  = (18ul << 0) |								 
									(3ul << 16) |								 
									(3ul << 20) |								 
									(3ul << 24)	;								 
		
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR			= (28ul << 8) | ((uint8_t)0x01);
		
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FM1R		= 0x0FFFFFFF;									 
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FS1R		= 0;													 
	
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->sFilterRegister[0].FR1	= (0ul << 5) | (1u << 21);
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->sFilterRegister[0].FR2	= (2ul << 5) | (3u << 21); 

	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FA1R		= ((uint16_t)0x0001);							 
		
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR		 &=	~((uint8_t)0x01);							 
	((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->MCR 	 &= ~((uint16_t)0x0001);							 
};
