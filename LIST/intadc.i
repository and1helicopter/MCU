...
void InitIntADC() {
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->PMC		|= (((uint32_t)0x00010000));

	 
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR	|= (((uint32_t)0x00000100) | ((uint32_t)0x00000200));

	((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR		=	 0x06   			 |				 
								(0x02ul << 14) |				 
	  						 ((uint32_t)0x00002000)	 |				 
								(0x01ul	<< 16) ;				 
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->CR1		= ((uint32_t)0x00000100);
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->CR1		= ((uint32_t)0x00000100);
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->CR2		= ((uint32_t)0x00000001) | (0x08ul << 24) | (0x01ul << 28);

	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->CR2		= ((uint32_t)0x00000001);
	
	 
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->SMPR1	= 												(0x03ul << 24)|(0x03ul << 21)|(0x03ul << 18)|(0x03ul << 15)|
								(0x03ul << 12)|(0x03ul <<  9)|(0x03ul <<  6)|(0x03ul <<  3)|(0x03ul << 0);

	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->SMPR2	= (0x03ul << 27)|(0x03ul << 24)|(0x03ul << 21)|(0x03ul << 18)|(0x03ul << 15)|
								(0x03ul << 12)|(0x03ul <<  9)|(0x03ul <<  6)|(0x03ul <<  3)|(0x03ul << 0);
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->SMPR1	= 												(0x03ul << 24)|(0x03ul << 21)|(0x03ul << 18)|(0x03ul << 15)|
								(0x03ul << 12)|(0x03ul <<  9)|(0x03ul <<  6)|(0x03ul <<  3)|(0x03ul << 0);
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->SMPR2	= (0x03ul << 27)|(0x03ul << 24)|(0x03ul << 21)|(0x03ul << 18)|(0x03ul << 15)|
								(0x03ul << 12)|(0x03ul <<  9)|(0x03ul <<  6)|(0x03ul <<  3)|(0x03ul << 0);
	
	
	 
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->SQR1	= ((2ul - 1) << 20);
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->SQR1	= ((2ul - 1) << 20);
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))->SQR3	= (5ul << 10) | (5ul << 5) | (3ul);
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))->SQR3	= (7ul << 10) | (7ul << 5) | (4ul);
	...
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070))->PAR 	= (unsigned int)&(((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CDR);
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070))->M0AR 	= (unsigned int)Metro . StdCmnd . StdCmnd .IntADCData;
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070))->NDTR 	= 2ul * 8;
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070))->CR	 	= (0ul << 25) 	|												 
												(0ul<< 6)			|												 
												((uint32_t)0x00000100)	|												 
												((uint32_t)0x00000400)	|												 
												((uint32_t)0x00000010)	|												 
