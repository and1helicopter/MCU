...
int  TempTime;
	...
	if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR != 0x8103) 																									   
  {
		((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= ((uint32_t)0x00000100);																										 
		
		if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR & 0x0204) 																									 
    {
			((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= ((uint32_t)0x00010000);																						 
			while (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR & 0x0304);																							 
    }	
				
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR &=~((uint32_t)0x00010000);																							 
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= ((uint32_t)0x00000001);																							 
		while (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR & ((uint32_t)0x00000002)) == 0) && (--Timeout));							 

		if (Timeout == 0) return 0;				
	
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR	|= (((uint32_t)0x00000100) | ((uint32_t)0x00008000));										 
	} 
	
	 
	if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR != 0x8103) return 0;
  ...
  {	 
    ...
    switch ("May 15 2018"[0]) 
    {
      ...
      case 0x4F:	TempDate |= 0x1000; break;															 
      case 0x4E:	TempDate |= 0x1100; break;															 
      case 0x44:	TempDate |= 0x1200; break;															 
...
uint32_t SS, T, D;  
	if (!(RtcWait | (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR & ((uint32_t)0x00000020)))) return 0;				           
  while ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR & ((uint32_t)0x00000020)) == 0);                                 
		
  SS = 0xFF - (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->SSR & 0xFF);
  T  = ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->TR;
  D  = ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->DR;
  ...
  OldSS = SS;
	...
	*RtcTime = (T & 0x003FFFFF) | ((((SS * 1000) << 14) + (ms << 22)) & 0xFFC00000);       
	*RtcDate = D | (SS << 24);                                                             
	
  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR = ~((uint32_t)0x00000020);
	return 1;
...
void SetRTC(uint32_t Date, uint32_t Time) {
  ...
  if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR != 0x8103) return;																						 
	...
	while ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR & ((uint32_t)0x00000040)) == 0);																		  
    
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->DR		= Date;
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->TR 	= Time & 0x003F7F7F;

	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR &= ~((uint32_t)0x00000080);
  

  
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->WPR 	= 0x00;
...
int8_t DayInMonth[12] = {31,29,31,30,31,30,31,31,30,31,30,31};
	...
	DW = (Y-12)*365 + (Y-13)/4;														 
	for (i = 1; i < M; i++) DW += DayInMonth[i-1];				  
	DW += D;																							 
	DW %= 7;																							 
	if (DW == 0) DW = 7;																	 
