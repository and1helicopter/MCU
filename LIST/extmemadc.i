...
void InitExtMem(void) {
	...
	if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB3ENR & ((uint32_t)0x00000001)) return;				 

   
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB3ENR |= ((uint32_t)0x00000001);	


   
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[0]  = 0x00005011;		 
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[1]  = 0x00020302;		 
  ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[0] = 0x00020202;		 	

  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[2]  = 0x00005011;		 
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[3]  = 0x00020302;		 
  ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[2] = 0x00020202;		 	
	
#line 40 "PERIPH\\Extmemadc.c"



	(*(volatile unsigned int *)((((unsigned int)(&((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->ODR) - ((uint32_t)0x40000000))*32 + 1*4) + ((uint32_t)0x42000000))) = 0;
	(*(volatile unsigned int *)((((unsigned int)(&((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->ODR) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 1;

	 	
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[4]  = 0x00005011;		 
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[5]  = 0x00020403;		 
  ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[4] = 0x00020403;		 		

	(*(volatile unsigned int *)((((unsigned int)(&((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->ODR) - ((uint32_t)0x40000000))*32 + 2*4) + ((uint32_t)0x42000000))) = 0;
...
TIM_TypeDef	*TIM = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400));

	Metro .pExtADCArray = Metro .ExtADCArray;
	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= ((uint32_t)0x00000002);
	TIM->PSC 		= 0;
	TIM->ARR 		= ((SystemCoreClock / 4) * 2) / freq - 1;						 
	TIM->CCR4 	= ((SystemCoreClock / 4) * 2) / 200000; 						 
	...
	TIM->CCMR2 	= (0x68ul << 8);											 
  TIM->DIER 	= ((uint16_t)0x0010);											 
	TIM->CCER		=	((uint16_t)0x1000);	
	 
	TIM->SMCR		= ((uint16_t)0x0005);
	
	TIM->CR2		= ((uint16_t)0x0070);										 
	
	TIM->CR1		= (((uint16_t)0x0080) | ((uint16_t)0x0001));
...
int i;
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->SR = ~((uint16_t)0x0010);
	for (i = 0; i < 16; i++) *Metro .pExtADCArray++ = ExtADC[i];
	if (Metro .pExtADCArray == &Metro .ExtADCArray[16*8]) Metro .pExtADCArray = Metro .ExtADCArray;
}
